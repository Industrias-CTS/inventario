...
exports.getComponentReport = exports.getInventoryReport = exports.getMovementsReport = void 0;
...
const getMovementsReport = async (req, res) => {
    ...
    `;
        ...
        const movements = await database_config_1.db.query(query, params);
...
const getInventoryReport = async (_req, res) => {
    try {
        const inventory = await database_config_1.db.query(`
      SELECT 
        c.id,
        c.code,
        c.name,
...
const getComponentReport = async (req, res) => {
    try {
        ...
        const component = await database_config_1.db.get(`
      SELECT 
        c.*,
        cat.name as category_name,
        u.symbol as unit_symbol
    ...
    `;
        ...
        const movements = await database_config_1.db.query(movementsQuery, params);
...
exports.getComponentReport = getComponentReport;

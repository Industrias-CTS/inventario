...
router.post('/', auth_1.authenticate, (0, auth_1.authorize)('admin', 'user'), [
    ...
    (0, express_validator_1.body)('output_component_id').notEmpty().withMessage('ID de componente de salida es requerido'),
    ...
    (0, express_validator_1.body)('ingredients.*.component_id').notEmpty().withMessage('ID de componente ingrediente es requerido'),

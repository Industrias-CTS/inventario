...
router.post('/', auth_1.authenticate, (0, auth_1.authorize)('admin', 'user'), [
    ...
    (0, express_validator_1.body)('unit_id').isUUID().withMessage('ID de unidad inválido'),
    (0, express_validator_1.body)('min_stock').isNumeric().withMessage('Stock mínimo debe ser numérico'),
    (0, express_validator_1.body)('cost_price').isNumeric().withMessage('Precio de costo debe ser numérico'),

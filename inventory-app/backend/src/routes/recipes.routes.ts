...
router.post(
  ...
  [
    ...
    body('output_component_id').notEmpty().withMessage('ID de componente de salida es requerido'),
    ...
    body('ingredients.*.component_id').notEmpty().withMessage('ID de componente ingrediente es requerido'),
